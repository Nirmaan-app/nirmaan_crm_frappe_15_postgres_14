...
//         return date;
//     } catch (e) {
//         console.error("Error parsing date string:", dateString, e); // LOG
//         return undefined;
//     }
// }
...
//     // Initial state setup (these are fine)
...
//     // This effect synchronizes internal UI state with TanStack Table's filter state
//     React.useEffect(() => {
//         const currentFilter = column.getFilterValue() as DateFilterValue | undefined;
//         console.log(`[DateFilter - ${column.id}] Syncing. Current table filter:`, currentFilter); // LOG
        
//         // Reset states if no filter or unexpected type
...
//     }, [column.getFilterValue()]); // Depend on the filter value from the column
...
//             }
//         }
//         console.log(`[DateFilter - ${column.id}] Applying filter:`, newFilter); // LOG
//         column.setFilterValue(hasValidValue ? newFilter : undefined);
//         setPopoverOpen(false);
//     };

//     const handleClearFilter = () => {
//         console.log(`[DateFilter - ${column.id}] Clearing filter.`); // LOG
...
//                                  selected={dateRange}
//                                  onSelect={(range) => {
//                                     // Ensure range is not null/undefined before setting state
...
//                             handleClearFilter();
//                         }}>Clear</Button>
//                      <Button size="sm" onClick={handleApplyFilter} className="bg-destructive hover:bg-destructive/90">Apply</Button>
//                 </div>
//             </PopoverContent>
//         </Popover>
//     );
