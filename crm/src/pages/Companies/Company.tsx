...
//     const { overlayOpen, setOverlayOpen, toggleTaskDialog } = useApplicationContext()
//     const navigate = useNavigate()
...
//             action: () => navigate(`/contacts/new?company_id=${id}`)
//         },
//         {
//             label: 'Add New BOQ',
//             action: () => navigate(`/boqs/new?company_id=${id}`)
//         },
//         {
//             label: 'Add New Tasks',
//             action: () => toggleTaskDialog({ companyId: id })
//         }
//     ];
...
//                     {overlayOpen && (
//                         <div
//                             className="p-6 bg-destructive text-white shadow-lg rounded-xl w-56"
...
//                                             {option.label}
//                                         </button>
//                                         {index < fabOptions.length - 1 && <Separator className="bg-white/30 mt-4" />}
//                                     </li>
//                                 ))}
//                             </ul>
//                         </div>
...
//                         className="p-4 bg-destructive text-white rounded-full shadow-lg flex items-center justify-center transition-transform duration-300"
//                     >
//                         {overlayOpen ? <X size={28} /> : <Plus size={28} />}
//                     </button>
//                 </div>
//             )} */}
            
//             {/* This dialog can now be triggered with the correct context */}
//             <NewTaskForm />
